...
parser.add_argument("--save_path", type=str, default="ASEM_Model.pt")
...
parser.add_argument("--topk_stn", type=int, default=2)
...
parser.add_argument("--model", type=str, default="experts")
...
emb_file = arg.emb_file or "vectors/glove.6B.300d.txt"
